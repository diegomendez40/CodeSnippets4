...
new Curso("Ingenierí­a de software para la web", 15, 99, true, 2018),
new Curso("Pruebas automatizadas", 25, 50, false, 2020),
new Curso("Principios de diseño y arquitectura", 30, 75, true, 2020)];

export const ap = new Aprendiz("Diego", "Méndez Romero", "avatar.png", 30, NivelEducativo.POSGRADO, cursos);
